...
QBCore.Functions.CreateCallback('qs-smartphone:server:TransferCid', function(_, cb, NewCid, house)
...
QBCore.Functions.CreateCallback('qs-smartphone:server:MeosGetPlayerHouses', function(_, cb, input)
    if input then
